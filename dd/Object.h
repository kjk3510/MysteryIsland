...
{
public:
	CHeightMap* m_pCollisionMap;
	virtual void SetCollisionMap(CHeightMap* pCollisionMap) { m_pCollisionMap = pCollisionMap; }
...
{
public:
	CHeightMapTerrain(ID3D11Device *pd3dDevice, LPCTSTR pFileName, int nWidth, int nLength, int nBlockWidth, int nBlockLength, D3DXVECTOR3 d3dxvScale, D3DXCOLOR d3dxColor, DWORD dType = 0, bool bReverse = FALSE);
