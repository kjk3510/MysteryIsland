...
class CInstancingShader : public CIlluminatedShader
{
	//다음 멤버변수를 추가한다.
private:
	//재질관련 변수
...
public:
	...
	virtual void BuildObjects(ID3D11Device *pd3dDevice, CHeightMapTerrain *pHeightMapTerrain, CMaterial *pMaterial, int k);
...
private:
	...
	ID3D11Buffer *m_pd3dCubeInstanceBuffer[2];
...
/////////////////////////////
class CTerrainShader : public CDiffusedShader
{
public:
	CTerrainShader();
