...
void Terrain::Draw(ID3D11DeviceContext* dc, const Camera& cam, DirectionalLight lights[3], PointLight pointLight)
{
	...
	//	dc->IASetIndexBuffer(mQuadPatchIB, DXGI_FORMAT_R32_UINT, 0);
	...
	//	dc->DrawIndexed(mLandIndexCount, 0, 0);
	//}
...
void Terrain::LoadHeightmap()
{
	...
	std::vector<unsigned char> in(mInfo.HeightmapWidth * mInfo.HeightmapHeight); //4,198,401
